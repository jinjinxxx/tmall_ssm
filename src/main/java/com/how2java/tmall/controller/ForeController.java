...
public class ForeController {
	...
	public String buy(Model model, String[] oiid, HttpSession session) {
		...
		for (String strid : oiid) {
			...
			List<ProductImage> lists = productImageService.list(oi.getPid(), ProductImageService.type_single);
			// p.setFirstProductImage(lists.get(0));
			oi.getProduct().setFirstProductImage(lists.get(0));
